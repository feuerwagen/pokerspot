 ...
 * to determine the best hand.  Example: kickers A,2 will mathematically beat 
 * kickers K,Q.
 * 		k1			k2
 * A		0.50		0.0013
 * K		0.49		0.0012
...
class pokerEval {
	...
	//points for the value of the hand
	public $points;
	//holds the text description of the hand
	public $text;
	//This is for the description of the kickers
	public $kicker1Text;
	public $kicker2Text;
	public $kicker3Text;
	public $kicker4Text;
	...
	//public $kickerArray = array();
			...
			{
				return pokerEval::getPoints()+pokerEval::getkicker1Points()+pokerEval::getkicker2Points()+pokerEval::getkicker3Points()+pokerEval::getkicker4Points();
