<?php /* Smarty version 2.6.22, created on 2010-09-01 23:08:06
         compiled from tpl_event.html */ ?>
<p>Guten Tag <?php echo $this->_tpl_vars['b']->name; ?>
,</p>
<p>Du hast Dich für den <?php echo $this->_tpl_vars['b']->start->returnDate('j.n.Y'); ?>
 bei uns auf der Burg angemeldet. Wir halten Dir für diesen Termin die gewünschten Räumlichkeiten frei.</p>
