...
// HACK start
	/*_createButtons:function(t){var n=this,r=!1;this.uiDialogButtonPane.remove(),this.uiButtonSet.empty(),typeof t=="object"&&t!==null&&e.each(t,function(){return!(r=!0)}),r?(e.each(t,function(t,r){r=e.isFunction(r)?{click:r,text:t}:r;var i=e("<button type='button'></button>").attr(r,!0).unbind("click").click(function(){r.click.apply(n.element[0],arguments)}).appendTo(n.uiButtonSet);e.fn.button&&i.button()}),this.uiDialog.addClass("ui-dialog-buttons"),this.uiDialogButtonPane.appendTo(this.uiDialog)):this.uiDialog.removeClass("ui-dialog-buttons")},//*/

	_createButtons:function(t){
		var n=this,r=!1;
		this.uiDialogButtonPane.remove(),
		this.uiButtonSet.empty(),
		typeof t=="object"&&t!==null&&e.each(t,function(){return!(r=!0)}),
		r?(e.each(t,function(t,r){
			if(r.type=='button') i=e('<button type="button"></button>').text(t).appendTo(n.uiButtonSet); 
			else i=e('<a href="#"></a>').attr('title', t).text(t).appendTo(n.uiButtonSet); 
			e.each(r,function(h,g){ 
				switch(h){ 
					case'call': 
						i.click(function(){
							i.button('disable');g.apply(n.element[0],arguments);return false;
						}); 
						break; 
					case'class': 
						i.addClass(g); 
