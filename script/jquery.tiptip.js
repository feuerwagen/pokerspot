...
(function($){
	$.fn.tipTip = function(options) {
		var defaults = { 
			...
			url: false, // get content by ajax
			data: '', // options for ajax call
		  	enter: function(){},
		  	exit: function(){}
	  	};
		...
		return this.each(function(){
			...
			if(org_title != "" || opts.url){
				...
				function active_tiptip(){
					...
					tiptip_holder.css({"margin-left": marg_left+"px", "margin-top": marg_top+"px", "max-width": opts.maxWidth}).attr("class","tip"+t_class);
